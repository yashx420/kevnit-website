...
export function ServiceCard({ service, index }: ServiceCardProps) {
  ...
  return (
    <motion.div
      className={`group relative h-full w-full rounded-[2.5rem] md:rounded-[3.5rem] border border-white/10 bg-[#111] md:bg-gradient-to-br md:from-white/[0.07] md:to-transparent backdrop-blur-none md:backdrop-blur-xl overflow-hidden shadow-none md:shadow-[0_30px_60px_-15px_rgba(0,0,0,0.9),inset_0_1px_0_0_rgba(255,255,255,0.1)] transition-all duration-500 will-change-transform`}
    ...
    >
      ...
      <div className="relative z-20 flex flex-col h-full p-6 md:p-8 lg:p-10">
        ...
        <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-5 mb-4 md:mb-6">
          ...
          <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold font-heading text-white md:text-transparent md:bg-clip-text md:bg-gradient-to-br from-white to-white/60 tracking-tight leading-none uppercase transition-opacity duration-500 group-hover:opacity-100">
            {service.title}
          </h3>
        </div>
