                ...
                >
                  ...
                  >
                    <motion.div
                      ...
                      className="group relative bg-[#111]/90 backdrop-blur-md border border-white/10 p-8 rounded-3xl overflow-hidden hover:bg-[#151515] transition-all duration-500 no-cursor-effect"
                    >
                      {/* Holographic Sheen */}
