...
export function Process() {
  ...
  return (
    <section ref={container} className="py-32 bg-[#050505] relative overflow-hidden min-h-[150vh]">
      {/* Chaotic Background Elements */}
      <div className="absolute inset-0 opacity-20 pointer-events-none">
         <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_50%_50%,rgba(0,230,118,0.1),transparent_70%)] animate-pulse" />
      ...
      <Container className="relative z-10">
        <AnimatedWrapper className="text-center mb-24">
          <h2 className="text-4xl md:text-7xl font-bold text-white mb-6 tracking-tighter uppercase glitch-text" data-text="Our Process">
            Our Process
          </h2>
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <div className="absolute left-[20px] md:left-1/2 top-0 bottom-0 w-1 md:-ml-0.5 bg-white/10 h-full rounded-full overflow-hidden">
            <motion.div 
              ...
              className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-[#00E676] via-emerald-400 to-[#00E676] shadow-[0_0_20px_#00E676] box-shadow-glow"
            />
          </div>
          ...
          <div className="space-y-24">
            {steps.map((step, index) => (
              <div key={index} className={`relative flex items-center ${index % 2 === 0 ? "md:flex-row" : "md:flex-row-reverse"} flex-row`}>
                ...
                <div className="absolute left-[20px] md:left-1/2 -ml-[20px] md:-ml-5 w-10 h-10 rounded-full bg-[#0A0A0A] border-4 border-[#00E676] z-20 flex items-center justify-center shadow-[0_0_15px_#00E676]">
                ...
                {/* Content Card */}
                <div className={`w-full md:w-1/2 ${index % 2 === 0 ? "pl-16 md:pl-16 md:pr-0" : "pl-16 md:pl-0 md:pr-16 text-right"}`}>
                  <AnimatedWrapper 
                  ...
                  >
                    ...
                    >
                      ...
                      <div className={`flex flex-col ${index % 2 !== 0 ? "md:items-end" : "md:items-start"}`}>
                        <span className="text-6xl md:text-8xl font-bold text-white/5 absolute -top-4 -right-4 md:-left-4 select-none group-hover:text-white/10 transition-colors">
                          {step.number}
                        </span>
                        
                        <div className="relative mb-4 inline-block">
                          <span className="text-4xl">{step.icon}</span>
                          <div className="absolute inset-0 filter blur-xl opacity-50 bg-[#00E676] rounded-full" />
                        </div>
