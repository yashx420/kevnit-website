...
export function CTA() {
  return (
    <section className="py-6 md:py-24 bg-gradient-to-br from-[#6BC323] to-[#58a51c] text-black relative overflow-hidden">
      ...
      <Container className="relative z-10 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link href="/contact">
            <Button
              size="lg"
              className="bg-black text-white hover:bg-black/80 border-none min-w-[200px] h-14 text-lg shadow-xl"
            >
          ...
          <Link href="/services">
            <Button
              variant="outline"
              size="lg"
              className="border-black text-black hover:bg-black/10 min-w-[200px] h-14 text-lg"
            >
              Explore Services
            </Button>
          </Link>
